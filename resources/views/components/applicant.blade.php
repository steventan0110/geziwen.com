@if($agency->type==1)
    <div class="media pt-3">
        <span class="badge badge-info">申请案例</span>
...
@else
    <div class="media pt-3">
        <span class="badge badge-danger">语培案例</span>
        <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                            ...
                            <div class="card-header">
                                <ul class="nav nav-tabs card-header-tabs pull-right" role="tablist">
                                    ...
                                    @if($applicant->exam_type_id == 2)
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#applicant-{{ $applicant->id }}-toefl" role="tab" aria-controls="applicant-{{ $applicant->id }}-toefl" aria-selected="true">TOEFL</a>
                                        </li>
                                    @endif
